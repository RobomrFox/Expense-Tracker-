...
const Sidebar = function () {
    ...
    return (
        <>
            <aside className={`${isCollapsed ? "w-16" : "w-64"} bg-purple-200 border-r transition-all duration-300`}>
                ...
                <nav className={`${isCollapsed ? "flex justify-center flex-col" : ""} mx-2 p-1 mt-30`}>
                    <div className={`flex items-center ${isCollapsed ? "justify-center" : "justify-start"} gap-2 hover:bg-purple-500/10 rounded p-1`}>
