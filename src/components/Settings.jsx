function Settings({ closeToggleSettingsModal }) {
    function bgClickCloseModal(e) {
        if (e.target.id === "modal-bg") {
            closeToggleSettingsModal();
        }
    }
    return (
            ...
            <div className="bg-white rounded-lg">
                ...
                <div className="py-5">
                    <div className="space-x-5">
                        <button className="min-w-20" onClick={closeToggleSettingsModal}>BACK</button>
                        <button className="bg-blue-500 text-white rounded-xl min-w-20" onClick={closeToggleSettingsModal}>CREATE</button>
                    </div>
                </div>
            </div>
        </div>
